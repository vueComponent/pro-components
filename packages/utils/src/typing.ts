...
import { anyType, booleanType, stringType, vNodeType } from '@v-c/utils'
...
export const valueTypeWithFieldPropsBase = {
  valueType: anyType<ValueTypeWithFieldPropsBase['valueType']>(),
  fieldProps: anyType<ValueTypeWithFieldPropsBase['fieldProps']>()
}
...
export type ProSchemaValueEnumObj = Record<
  ...
  ProSchemaValueEnumType | VNodeChild
>
type UseEditableUtilType = Record<string, any>
...
export const proSchemaProps = (entity = {}, extraProps = {}) => {
  return {
    ...extraProps,
    ...entity,
    ...valueTypeWithFieldPropsBase,
    key: anyType<ProSchema['key']>(),
    dataIndex: anyType<ProSchema['dataIndex']>(),
    title: anyType<ProSchema['title']>(),
    tooltip: anyType<ProSchema['tooltip']>(),
    tip: anyType<ProSchema['tip']>(),
    valueEnum: anyType<ProSchema['valueEnum']>(),
    formItemProps: anyType<ProSchema['formItemProps']>(),
    renderText: anyType<ProSchema['renderText']>(),
    render: anyType<ProSchema['render']>(),
    renderFormItem: anyType<ProSchema['renderFormItem']>(),
    editable: anyType<ProSchema['editable']>(),
    request: anyType<ProSchema['request']>(),
    debounceTime: anyType<ProSchema['debounceTime']>(),
    params: anyType<ProSchema['params']>(),
    dependencies: anyType<ProSchema['dependencies']>(),
    ignoreFormItem: anyType<ProSchema['ignoreFormItem']>(),
    hideInDescriptions: anyType<ProSchema['hideInDescriptions']>(),
    hideInForm: anyType<ProSchema['hideInForm']>(),
    hideInTable: anyType<ProSchema['hideInTable']>(),
    hideInSearch: anyType<ProSchema['hideInSearch']>(),
    proFieldProps: anyType<ProSchema['proFieldProps']>()
  }
}
...
export const proFieldProps = {
  ...
  emptyText: vNodeType(),
  label: vNodeType(),
  mode: stringType<'read' | 'edit'>(),
  proFieldKey: stringType(),
  render: anyType(),
